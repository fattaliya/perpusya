      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="/" class="app-brand-link">
              ...
              <span class =" text-center text text-uppercase app-brand-text demo menu-text fw-bolder ms-6">SMK NEGERI <br>1 BATIPUH</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="" class="menu-link menu-toggle">
                ...
                <div data-i18n="Layouts">Master Anggota</div>
              </a>

              <ul class="menu-sub">
                  <a href="/admin/data_siswa" class="menu-link">
              ...
              <a href="" class="menu-link menu-toggle">
                ...
                <div data-i18n="Layouts">Master Buku</div>
              </a>
              ...
              <li class="menu-item">
                ...
                <li class="menu-item">
                  <a href="/admin/pengarang" class="menu-link">
                    <div data-i18n="Without navbar">Pengarang</div>
                  </a>
                </li>
                <li class="menu-item">
        ...
        <!-- Cards -->
            ...
            <li class="menu-item">
                ...
                <ul class="menu-sub">
                <li class="menu-item">
                    <a href="/admin/buku/print" class="menu-link">
                      <i class="menu-icon tf-icons bx bx-book"></i>
                      <div data-i18n="Fluid">Laporan Buku</div>
                    </a>
                  </li>

                   <li class="menu-item">
                     <a href="/admin/data_siswa/print" class="menu-link">
                      <i class="menu-icon tf-icons bx bx-book"></i>
                      <div data-i18n="Fluid">Laporan Anggota</div>
                    </a>
                  </li>

                  <li class="menu-item">
                      <a href="/admin/peminjaman/print" class="menu-link">
                       <i class="menu-icon tf-icons bx bx-book"></i>
                       <div data-i18n="Fluid">Laporan Peminjaman</div>
                     </a>
                   </li>
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                      <img src="{{url('assets')}}/img/avatars/3.jpg" alt class="w-px-40 h-auto rounded-circle" />
                    </div>
                  </a>
            ...
            <footer class="content-footer footer bg-footer-theme">
              <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
                <div class="mb-2 mb-md-0">
                  ...
                  ,❤️ by
                  <a href="https://www.instagram.com/zkrfttly/" target="_blank" class="footer-link fw-bolder">yaya</a>
                </div>
            </div>
            </footer>
            <!-- / Footer -->
